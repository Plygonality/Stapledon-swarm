...
Markdown pages embed [`display/`](display/) copies, 1600 px wide, stored as ordinary git files. That is what shows while reading, including on a phone. The seven files in this folder are the full renders, tracked with Git LFS.

## Kepler system

![Kepler-62 with an irregular silhouette on the disk and a cell veil](display/01-eclipse.jpg)
...
![Rows of dark geometric cells receding, K-disk in the upper right](display/02-lattice.jpg)
...
![Looking inward: lattice on the disk, small circular transit, irregular body in the foreground](display/03-inward.jpg)
...
![Hub, chassis, and four spars of a lightsail probe, Earth faint in the background](display/04-boom.jpg)
...
![Edge-on lightsail as a thin bright cross against Earth's disk](display/05-cross.jpg)
...
![Reflective diamond lightsail, square-on-point, four circular illumination marks](display/06-face.jpg)
...
![Several diamond lightsails as dark silhouettes against Earth's limb](display/07-fleet.jpg)
